...
\midrule
AR (123.6M, 20K steps) & H100 80GB (Colab) & 107.9 min & ${\sim}$\$35 \\
MDLM (162.7M, 20K steps) & H100 80GB (Colab) & 113.0 min & ${\sim}$\$35 \\
\midrule
\textbf{Total} & & \textbf{220.9 min} & $\boldsymbol{\sim}$\textbf{\$70} \\
\bottomrule
\end{tabular}
\end{table}
